...
import { Eye, EyeOff, Mail, Lock, ArrowRight, Smartphone, Sparkles } from "lucide-react"
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="shadow-2xl border-0 bg-white/90 backdrop-blur-sm">
          <CardHeader className="space-y-1 pb-6">
            ...
            <p className="text-center text-gray-600">Faça login para acessar sua conta</p>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 h-12 border-gray-200 focus:border-blue-400 shadow-sm bg-white/80"
                    required
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 pr-10 h-12 border-gray-200 focus:border-blue-400 shadow-sm bg-white/80"
                    required
                  />
                  <button
                    type="button"
              ...
              <Button
                type="submit"
                className="w-full h-12 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 shadow-lg transform hover:scale-105 transition-all duration-200 font-semibold"
                disabled={isLoading}
              >
                {isLoading ? (
